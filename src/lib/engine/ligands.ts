...
export const legantiComuni: Record<string, CommonLigand> = {
  ...
  "NO (nitrosyl)": {
    description: "N-donor radical, 1 N-14 (I=1) — important in bioinorganic",
    denticity: 1,
    nuclei: [{ isotope: "N-14", n: 1, A_par: 22.0, A_perp: 16.0 }],
  },
  ...
  "SPh⁻ (thiophenolate)": {
    description: "S-donor, S-33 (I=3/2) — rare isotope — model metalloprotein ligand",
    denticity: 1,
    nuclei: [],
    distant_nuclei: [["H-1 (Protium)", 5, 5.0, 3.5]],
  },
  "Cys⁻ (cysteinate)": {
    description: "S,N-donor bidentate, 1 N-14 — amino acid ligand",
    denticity: 2,
    nuclei: [{ isotope: "N-14", n: 1, A_par: 20.0, A_perp: 15.0 }],
    distant_nuclei: [["H-1 (Protium)", 2, 8.0, 5.0]],
  },
  "S²⁻ (sulfide)": {
    description: "S-donor (bridging), S-33 (I=3/2, 0.76%) — Fe-S clusters",
    denticity: 1,
    nuclei: [],
  },
  "SePh⁻ (selenophenolate)": {
    description: "Se-donor, Se-77 (I=1/2, 7.6%)",
    denticity: 1,
    nuclei: [{ isotope: "Se-77", n: 1, A_par: 40.0, A_perp: 25.0 }],
  },
  "NCS⁻ (thiocyanate-S)": {
    description: "S-donor (S-bonding isomer), no magnetic nucleus nearby",
    denticity: 1,
    nuclei: [],
  },
};
